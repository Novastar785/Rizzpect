...
export default function SelectPetForReportScreen() {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <Text style={styles.infoText}>
          Select the pet you want to generate a PDF report for:
        </Text>
        <FlatList
          data={pets}
          keyExtractor={(item) => item.id}
          renderItem={({ item }) => (
            <Link href={`/(app)/(tabs)/care/generateReport/${item.id}`} asChild>
